  ...
  <header class="header" data-header>
    <div class="container">
      ...
      <nav class="navbar" data-navbar>
        ...
        <a href="FormLogin.php" class="navbar-action-btn">Log Out</a>
      </nav>
    ...
    <article>
      ...
      <section class="section hero has-bg-image" id="home" aria-label="home"
        ...
        <div class="container">
          ...
          <a href="products.php" class="btn">Beli Sekarang</a>
          ...
          <ul class="grid-list">
            ...
            <li>
              <div class="offer-card has-bg-image img-holder"
                ...
                Time for some Christmas <span class="span">moments with Bluey!</span>
                  </h3>
            ...
            <li>
              <div class="product-card">
                ...
                <div class="card-content">
                  ...
                  <h3 class="h3">
                    <a href="products.php" class="card-title">Brit care - Activity Support</a>
                  </h3>
            ...
            <li>
              <div class="product-card">
                ...
                <div class="card-content">
                  ...
                  <h3 class="h3">
                    <a href="products.php" class="card-title">Brit care - Power & Vitality</a>
                  </h3>
            ...
            <li>
              <div class="product-card">
                ...
                <div class="card-content">
                  ...
                  <h3 class="h3">
                    <a href="products.php" class="card-title">Me-O Tuna</a>
                  </h3>
            ...
            <li>
              <div class="product-card">
                ...
                <div class="card-content">
                  ...
                  <h3 class="h3">
                    <a href="products.php" class="card-title">Me-O Seafood</a>
                  </h3>
