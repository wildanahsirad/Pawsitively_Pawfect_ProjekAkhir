   ...
   <table>
      ...
      <tbody>
         ...
         <tr>
            ...
            <td><a href="cart.php?remove=<?php echo $fetch_cart['id']; ?>" onclick="return confirm('hapus produk dari keranjang?')" class="delete-btn"> <i class="fas fa-trash"></i> remove</a></td>
         </tr>
         <?php
         ...
         <tr class="table-bottom">
            ...
            <td><a href="cart.php?delete_all" onclick="return confirm('apa anda yakin ingin menghapus semua?');" class="delete-btn"> <i class="fas fa-trash"></i> delete all </a></td>
         </tr>
